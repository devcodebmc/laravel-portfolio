...
<footer id="contact" class="relative py-16 px-6 lg:px-16 overflow-hidden">
    <div class="absolute inset-0 bg-[var(--bg-section)]">
    ...
    <div class="max-w-7xl mx-auto relative">
        <div class="text-center mb-12">
            <div class="flex items-center justify-center gap-4 mb-4">
                ...
                <span class="text-[11px] font-mono text-[var(--text-faint)] tracking-wider">// get in touch</span>
            </div>
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.08]">
                <span class="text-[var(--text-primary)]">Let's Build</span>
        ...
        <div class="flex flex-wrap items-center justify-center gap-6 mb-12">
            <div class="flex flex-wrap items-center justify-center gap-3">
                @php
                    $socialLinks = [
                        ['name' => 'GitHub', 'icon' => 'fab fa-github', 'url' => 'https://github.com/devcodebmc', 'color' => 'var(--text-primary)'],
                        ['name' => 'Instagram', 'icon' => 'fab fa-instagram', 'url' => '#', 'color' => '#E4405F'],
                        ['name' => 'CodePen', 'icon' => 'fab fa-codepen', 'url' => 'https://codepen.io/bryandevcode', 'color' => 'var(--text-primary)'],
                ...
                @foreach($socialLinks as $social)
                    <a href="{{ $social['url'] }}" target="_blank" rel="noopener noreferrer"
                       class="group w-14 h-14 rounded-full bg-[var(--bg-card)] border-2 border-[var(--border-color-alt)] flex items-center justify-center hover:border-[#807fe2] hover:shadow-lg hover:shadow-[#807fe2]/20 transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="relative group">
                <button id="likeButton" class="flex items-center gap-3 px-8 py-3.5 rounded-full bg-[var(--bg-card)] border-2 border-[var(--border-color-alt)] hover:border-[#807fe2] hover:shadow-lg hover:shadow-[#807fe2]/20 transition-all duration-300 hover:-translate-y-1 group">
                    <span class="flex items-center gap-2 text-sm font-medium text-[var(--text-muted)] group-hover:text-[#807fe2] transition-colors">
                ...
                <div class="absolute -top-12 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                    <span class="text-xs font-mono bg-[var(--text-primary)] text-[var(--bg-page)] px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg">
                        Show some love ❤️
                    </span>
                </div>
            </div>
        ...
        <div class="pt-8 border-t border-[var(--border-color-alt)]">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-md text-[var(--text-faint)] font-light">
                    ...
                    <span class="mx-2">•</span>
                    <a href="mailto:manzanocortesbrayan@gmail.com" class="text-[#807fe2] hover:text-[var(--text-muted)] transition-colors inline-flex items-center gap-2">
                        <i class="fas fa-envelope"></i>
                        manzanocortesbrayan@gmail.com
                    </a>
                </p>
                <div class="flex items-center flex-wrap justify-center gap-4">
                    <a href="https://github.com/devcodebmc" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-[#807fe2] hover:text-[var(--text-muted)] transition-colors">
                        <i class="fab fa-github"></i>
                        GitHub
                    </a>
                    <a href="https://bydsolutions.com" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-[#807fe2] hover:text-[var(--text-muted)] transition-colors">
...
{{-- Script para el like (sin cambios) --}}
@push('js')
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (likeButton) {
            likeButton.addEventListener('click', function(e) {
                ...
                setTimeout(() => heartIcon.classList.remove('scale-150'), 300);
                ...
                .then(data => {
                    ...
                    setTimeout(() => { likeCount.style.transform = 'scale(1)'; }, 200);
                })
