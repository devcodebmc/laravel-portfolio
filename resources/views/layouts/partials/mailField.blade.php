{{-- Get in touch --}}
        <div class="flex justify-center mb-8">
            <div class="text-center">
                <div class="flex items-center justify-center gap-3 mb-2">
                    <div class="w-12 h-12 rounded-full bg-[#f0edff] flex items-center justify-center text-[#807fe2]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-[#1a1a2e]">Get in touch</h3>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-center mb-12" id="mailField">
            <div class="w-full max-w-2xl">
                <form action="{{ route('sendMail') }}" method="POST" class="flex flex-col sm:flex-row gap-3">
                    ...
                    <div class="flex-1 relative">
                        <input type="email" 
                               ...
                               value="{{ old('email') }}"
                               required
                               class="w-full px-5 py-3.5 rounded-full bg-white border-2 border-[#e8e5f5] focus:border-[#807fe2] focus:outline-none focus:shadow-lg focus:shadow-[#807fe2]/10 transition-all duration-300 text-[#1a1a2e] text-sm placeholder:text-[#8a8aaa]"
                ...
                <p class="text-md text-[#8a8aaa] text-center mt-3 font-light">
